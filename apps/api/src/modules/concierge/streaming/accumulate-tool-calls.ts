 ...
 * The caller (ConciergeService) is responsible for parsing after the loop ends.
 */
 ...
 * - Chunk 1: { index: 0, id: 'call_abc', function: { name: 'search_venues', arguments: '{"query' } }
 * - Chunk 2: { index: 0, function: { arguments: '":"café' } }
